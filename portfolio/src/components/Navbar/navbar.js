...
import "./navbar.css";
import logo from "../../assets/sannskrutiLogo.png";
  ...
  return (
    <nav className="navbar">
      ...
      <div className="desktopMenu">
        ...
        <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Work Experience</Link>
      </div>
      ...
      <div className="navMenu" style={{display:showMenu?'flex':'none'}}>
        ...
        <Link activeClass="active" to="clients" spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>Work Experience</Link>
